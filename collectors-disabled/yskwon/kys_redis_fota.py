...
def oaq_set_pm():
	...
	key_name = "ingress-router/v1/memstore:kw/ctl/fota/v1/" + new_data["serial"]
	...
	channel_name = "ingress-router/v1/memstore.put:kw/ctl/fota/v1/" + new_data["serial"]
