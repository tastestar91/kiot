...
def test_group():
	new_data2 = {
		"g-suncheon@korea.kr": {
			...
			"kw-oske1": {
				"list": [ "OT3CL2000010", "OT3CL2000011", "OT3CL2000012" ]
			}
		}
	}
	...
	new_data_str1 = json.dumps(new_data1)
	new_data_str2 = json.dumps(new_data2)

	#----- Publish data to a Redis channel -----------------------------------
	channel_name = "ir-sensor-data-monitor/v1/groupmanager.put:ir-mon/groups/v1/update"

	rc.publish(channel_name, new_data_str2)
