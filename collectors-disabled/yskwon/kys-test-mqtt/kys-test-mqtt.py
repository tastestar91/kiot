...
try:
	...
	address = conf["servers"]["kwKiotCluster"]["mqtt"]["address"][2].split(":")
...
def mqtt_send_status():
	...
	while True:
		cnt += 1
		topic = 'kerv/ack/VENTTS1%05d' % cnt
		command = 'STAT010%d00000000' % random.randint(1,6)
...
if __name__ == '__main__':
	...
	try:
		...
		schedule.every().minutes.do(mqtt_send_status)
