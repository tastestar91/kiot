...
IR_SERVICE_ID = "kw-csbp1"
IR_SERVICE_ID_WATT = "kw-watt-csbp1"
...
SENSOR_FIELDS = [
	"power", "op_mode", "temp", "humi", "set_air_volume", "air_volume"
]
...
def process_message(msg):
	try:
		...
		if (data_header == "STAT") :
			...
			payload[data_sensor[2]] = data_str[4:9] # temp
			payload[data_sensor[3]] = data_str[9:12] # humi
			payload[data_sensor[4]] = data_str[12:14] # set_air_volume
			payload[data_sensor[5]] = data_str[14:16] # air_volume
